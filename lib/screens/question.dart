...
class _QuestionState extends State<Question> with WidgetsBindingObserver {
  ...
  mixcolors() {
    ...
    } else if (useranswers[currentindex] == 1) {
      setState(() {
        aColor = selectedColor;
        bColor = unselected;
        cColor = unselected;
    ...
    } else if (useranswers[currentindex] == 2) {
      setState(() {
        bColor = selectedColor;
        aColor = unselected;
        cColor = unselected;
    ...
    } else if (useranswers[currentindex] == 3) {
      setState(() {
        cColor = selectedColor;
        aColor = unselected;
        bColor = unselected;
    ...
    } else if (useranswers[currentindex] == 4) {
      setState(() {
        dColor = selectedColor;
        aColor = unselected;
        cColor = unselected;
  ...
  void checkSkippedQuestions() {
    ...
    if (skippedQuestions.isNotEmpty) {
      setState(() {
        currentindex = skippedQuestions.first;
      });
      speakthewhole();
    } else {
      compute();
